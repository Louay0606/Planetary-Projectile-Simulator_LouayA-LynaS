...
public class ViewController implements Initializable {
    ...
    @FXML
    private void mercuryClicked(MouseEvent event) {
    }

    @FXML
    private void earthClicked(MouseEvent event) {
    }

    @FXML
    private void marsClicked(MouseEvent event) {
    }

    @FXML
    private void jupiterClicked(MouseEvent event) {
    }

    @FXML
    private void saturnClicked(MouseEvent event) {
    }

    @FXML
    private void uranusClicked(MouseEvent event) {
    }
